        ...
        axios.post(`${api}/users/register`, payload)
            ...
            .catch(function (error) {
                ...
                if(typeof error.response.data.msg === 'string'){
                    ...
                    let errorMessage = error.response.data.msg[0].msg
                    setErrorMessage(errorMessage)
                }
                    ...
                    <div className="wrapper">
                        <div className="left">
                            <div className="sign-up-form active">
                                <h1>Sign up to E-commerce</h1>

                                <div className="social-buttons">
                                    <a title="Sign up via Google">
                                ...
                                <form action="">
                                    {invalidCredentials ? <div className="error-text">{errorMessage}</div> : ''}
                                    ...
                                    <div className="create-aacount">
                                        Already registered? <Link className="text-underline sign-in-form-btn" to="/"> Sign In</Link>
                                    </div>
                                </form>
                            </div>
                        </div>
